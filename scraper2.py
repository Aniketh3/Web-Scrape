...
# Save dictionary as JSON
        with open("scrape2_left.json", "w", encoding="utf-8") as json_file:
...
# Save structured data as JSON
        with open("scrape2_text.json", "w", encoding="utf-8") as json_file:
...
# Print structured content
        ...
        with open("scrape2.html", "w", encoding="utf-8") as file:
