...
def scrape_website():
    url = "https://www.sparkl.me/learn/ib/chemistry-hl/gas-laws-boyles-law-charless-law-avogadros-law/revision-notes/1272"  # Replace with the target website
...
# Save dictionary as JSON
        with open("scrape3_left.json", "w", encoding="utf-8") as json_file:
...
# Save structured data as JSON
        with open("scrape3_text.json", "w", encoding="utf-8") as json_file:
...
# Print structured content
        ...
        with open("scrape3.html", "w", encoding="utf-8") as file:
