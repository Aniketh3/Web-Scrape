...
def scrape_website():
    url = "https://www.sparkl.me/learn/ib/physics-sl/nuclear-fission-process/revision-notes/1807"  # Replace with the target website
...
# Save structured data as JSON
        with open("scrape1_text.json", "w", encoding="utf-8") as json_file:
...
# Print structured content
        ...
        with open("scrape1.html", "w", encoding="utf-8") as file:
